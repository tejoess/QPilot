                                                        ...
                                                        <ol className="space-y-6">
                                                            {section.questions.map((question, qIdx) => (
                                                                <li key={qIdx} className="flex gap-4 group">
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        <p
                                                                            className="text-[17px] leading-relaxed font-medium text-zinc-800 dark:text-zinc-200 print:text-black outline-none focus:ring-2 focus:ring-primary/20 rounded p-1 -m-1"
                                                                            contentEditable
                                                                            suppressContentEditableWarning
                                                                        >
                                                                            {question.text}
